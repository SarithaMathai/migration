...
> Condensed version of [`output-conventions.md`](./output-conventions.md) (the full universal-conventions
> reference used by the skills/agents pipeline) — this one is scoped to the skill-0N docs that link it.
