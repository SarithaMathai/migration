...
> Condensed version of [`federation-patterns.md`](./federation-patterns.md) (the full type-classification
> reference used by the skills/agents pipeline) — this one is scoped to story-writing.
