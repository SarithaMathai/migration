...
- Backend endpoints, verbs and payloads come from the story's *Current Behaviour* and the operation's pseudo-logic in `output/analysis/{domain}/be-02-resolver-analysis.md` at https://github.com/XXX — copy the legacy call sequence, do not redesign it.
