...
description: "Phase F — a federation/stitching contribution story (e.g. SPARK-PROD-F01) in apps/app"
---

Implement Phase-F story **${input:storyId:SPARK-PROD-F01}** in `apps/app`.
...
6. Report: confirm the blocking subgraph's status, AC line by line, and explicitly note the facade/story this replaces (e.g. "E03 TechPack facade stops populating this field").
