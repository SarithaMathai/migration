...
1. Read the story's *Current Behaviour* (the legacy switch/dispatch logic — e.g. category-code → concrete-type mapping) and *Target DGS Implementation* from the Jira ticket or `output/analysis/{domain}/be-04-stories.md` at https://github.com/XXX.
