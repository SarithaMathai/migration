...
2. Read the story's *Current Behaviour → Target → Files → Acceptance Criteria → Test Cases* (I will paste the Jira ticket if you don't have it; otherwise use `output/analysis/claims/be-04-stories.md` at https://github.com/XXX).
