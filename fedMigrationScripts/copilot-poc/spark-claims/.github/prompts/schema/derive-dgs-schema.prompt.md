...
1. Locate the target definition in `output/analysis/claims/be-03-schema.graphql` at https://github.com/XXX — that file is the derived target for this subgraph; copy its intent, don't re-derive from the legacy SDL.
