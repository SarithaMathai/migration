...
The target schema is translated from the source SDL (`code/schemas/SPARK_Watchlist.txt`), verified against
...
| Product `SPARK-PROD-F08` mislabel (separate vs internal) | — | Low | Reclassified to internal (CAT-2) | Architect |
