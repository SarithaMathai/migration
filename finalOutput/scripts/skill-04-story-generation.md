...
> **Depends on:** 02, 03, and 05. **Template:** [`story-template-junior.md`](./story-template-junior.md).
...
2. **Junior Definition of Ready** — a story isn't done until a junior could implement it with zero
   questions. Run the checklist in `story-template-junior.md` against every story.
