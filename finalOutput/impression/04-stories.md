...
Junior engineers: read *Current Behaviour → Target → Files → Acceptance → Tests* per story. **ACL is
context-only** (no ACL work). Impression is the **lowest-risk** domain — a good first migration.
...
depends_on: []
ext_services: []
files: [plm-product/apps/app/src/main/resources/schema/impression.graphqls, plm-product/.../config/ScalarConfig.kt]
blocked_by: none
```
...
phase: A
complexity: Low
depends_on: [SPARK-IMP-A01]
ext_services: []
files: [plm-product/apps/app/src/main/resources/schema/impression.graphqls]
blocked_by: none
```
...
depends_on: [SPARK-IMP-A01]
ext_services: []
files: [plm-product/.../service/ImpressionService.kt, plm-product/.../client/ImpressionClient.kt, plm-product/.../model/ImpressionDto.kt]
blocked_by: none
```
...
```yaml
id: SPARK-IMP-B01
operation: searchImpressionsByProductId
type: query
category: CAT-2
phase: B
complexity: Low
depends_on: [SPARK-IMP-A02, SPARK-IMP-A04]
ext_services: []
files: [plm-product/.../dataFetcher/ImpressionQueryDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-IMP-B02
operation: getImpressionCountsByProductId
type: query
category: CAT-2
phase: B
complexity: Low
...
```yaml
id: SPARK-IMP-D01
operation: updateImpressions
type: mutation
category: CAT-2
phase: D
complexity: Medium
depends_on: [SPARK-IMP-A04]
ext_services: []
files: [plm-product/.../dataFetcher/ImpressionMutationDataFetcher.kt]
blocked_by: none
```
...
### SPARK-IMP-F01 · Implement `Product.impressions` / `impressionCounts` (internal)
```yaml
id: SPARK-IMP-F01
operation: "Product.impressions,Product.impressionCounts"
type: field-resolver
category: CAT-2
phase: F
complexity: Low
depends_on: [SPARK-IMP-A04]
ext_services: []
files: [plm-product/.../dataFetcher/ProductImpressionFieldDataFetcher.kt]
blocked_by: none
```
...
complexity: Low
depends_on: [SPARK-IMP-A02, SPARK-IMP-A04]
ext_services: [{key: workspaceV2, severity: YELLOW}, {key: vmm, severity: BLUE}, {key: userAttributes, severity: BLUE}]
files: [plm-product/.../dataFetcher/ImpressionFieldDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-IMP-G02
operation: "ImpressionCount.counts"
type: field-resolver
category: CAT-2
phase: G
complexity: Medium
depends_on: [SPARK-IMP-A02, SPARK-IMP-A04]
ext_services: []
files: [plm-product/.../dataFetcher/ImpressionCountFieldDataFetcher.kt]
blocked_by: none
```
...
phase: G
complexity: Low
depends_on: [SPARK-IMP-B01, SPARK-IMP-B02, SPARK-IMP-D01, SPARK-IMP-G02]
ext_services: []
files: [plm-product/.../test/ImpressionParityTest.kt, plm-product/.../test/ImpressionDataFetcherTest.kt]
blocked_by: none
```
