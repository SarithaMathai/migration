...
> **Domain:** `bom` · **Target DGS:** `BomService` → `plm-product`
...
> **Machine-readable index:** [04-stories-index.yaml](./04-stories-index.yaml)

**How to use this file (junior engineers):** find your story ID, read *Current Behaviour* → *Target DGS
Implementation* → *Files* → *Acceptance Criteria* → *Test Cases*. You should not need to open the `.txt`
...
|-------|------|---------|-------|
| A | Foundation & Schema | A01–A05 | schema, types, stubs, type resolvers, service port |
| B | Core Reads | B01–B08 | one query per story; 4 are cacheable master data |
| C | Search & Listing | C01–C05 | elastic + supplier lookups |
| D | Mutations (simple) | D01–D05 | add / workspaces / lock / unlock / component-status |
| E | Complex Operations | E01 | `updateBom` 3-step non-atomic write |
| F | Federation Contributions | F01–F02 | BLOCKED-BY product domain |
| G | Field Resolvers & Tests | G01–G16 | one story per type block + parity harness |
...
```mermaid
graph TD
  A01[A01 Schema skeleton] --> A02[A02 Owned types] & A03[A03 External stubs]
  A02 --> A04[A04 Type resolvers] & A05[A05 BomService port]
  A05 --> B[B01-B08 Reads] & C[C01-C05 Search] & D[D01-D05 Mutations] & E01[E01 updateBom]
  A04 --> G[G01-G15 Field resolvers]
  A05 --> G
...
depends_on: []
ext_services: []
files: [plm-product/apps/app/src/main/resources/schema/bom.graphqls, plm-product/.../config/ScalarConfig.kt]
blocked_by: none
```
...
phase: A
complexity: Medium
depends_on: [SPARK-BOM-A01]
ext_services: []
files: [plm-product/apps/app/src/main/resources/schema/bom.graphqls]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-A04
operation: "BomMaterialInterface,BomImpressionDetailsInterface"
type: field-resolver
category: CAT-2
phase: A
complexity: Medium
depends_on: [SPARK-BOM-A02]
ext_services: []
files: [plm-product/.../dataFetcher/BomTypeResolvers.kt]
blocked_by: none
```
...
depends_on: [SPARK-BOM-A01]
ext_services: []
files: [plm-product/.../service/BomService.kt, plm-product/.../client/BomClient.kt, plm-product/.../model/BomDto.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-B01
operation: getBomByIds
type: query
category: CAT-2
phase: B
complexity: Low
depends_on: [SPARK-BOM-A02, SPARK-BOM-A05]
ext_services: []
files: [plm-product/.../dataFetcher/BomQueryDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-B03
operation: getBomStatus
type: query
category: CAT-2
phase: B
complexity: Low
depends_on: [SPARK-BOM-A05]
ext_services: []
files: [plm-product/.../dataFetcher/BomQueryDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-B05
operation: getBomMaterialTypes
type: query
category: CAT-2
phase: B
complexity: Medium
depends_on: [SPARK-BOM-A05]
ext_services: [{key: materialHub, severity: YELLOW}]
files: [plm-product/.../dataFetcher/BomQueryDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-B06
operation: getBomPackagingMaterialTypes
type: query
category: CAT-2
phase: B
complexity: Low
...
```yaml
id: SPARK-BOM-B07
operation: getBomPackagingSubstrates
type: query
category: CAT-2
phase: B
complexity: Low
...
```yaml
id: SPARK-BOM-B08
operation: getBomPackagingUnitOfMeasure
type: query
category: CAT-2
phase: B
complexity: Low
...
files: [plm-product/.../dataFetcher/BomSearchDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-C02
operation: searchMaterialsBom
type: query
category: CAT-2
phase: C
complexity: Medium
depends_on: [SPARK-BOM-A05]
ext_services: [{key: search, severity: RED}, {key: vmm, severity: BLUE}]
files: [plm-product/.../dataFetcher/BomSearchDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-C03
operation: getComboSupplierForBom
type: query
category: CAT-2
phase: C
complexity: Medium
depends_on: [SPARK-BOM-A05]
ext_services: [{key: combination, severity: YELLOW}, {key: vmm, severity: BLUE}]
files: [plm-product/.../dataFetcher/BomSearchDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-C04
operation: getValidTrimSuppliersForBom
type: query
category: CAT-2
phase: C
complexity: Low
depends_on: [SPARK-BOM-A05]
ext_services: [{key: vmm, severity: BLUE}]
files: [plm-product/.../dataFetcher/BomSearchDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-C05
operation: getValidRawMaterialSuppliersForBom
type: query
category: CAT-2
phase: C
complexity: Low
...
depends_on: [SPARK-BOM-A05]
ext_services: []
files: [plm-product/.../dataFetcher/BomMutationDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-D05
operation: updateBomComponentStatus
type: mutation
category: CAT-2
phase: D
complexity: Low
...
depends_on: [SPARK-BOM-A05, SPARK-BOM-D02]
ext_services: [{key: workspaceV2, severity: YELLOW}]
files: [plm-product/.../service/BomUpdateOrchestrator.kt, plm-product/.../dataFetcher/BomMutationDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-F01
operation: "Product.productBoms,Product.boms,Product.packagingBoms"
type: field-resolver
category: CAT-2
phase: F
complexity: Medium
depends_on: [SPARK-BOM-A05]
ext_services: []
files: [plm-product/.../dataFetcher/ProductBomFieldDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-F02
operation: "ResourcesCount.bomsCount"
type: field-resolver
category: CAT-2
phase: F
complexity: Low
depends_on: [SPARK-BOM-A05]
ext_services: [{key: search, severity: RED}]
files: [plm-product/.../dataFetcher/ResourcesCountBomFieldDataFetcher.kt]
blocked_by: none
```
...
### SPARK-BOM-G01 · `Bom` + `Bom_Unified` field resolvers (9 shared fields)
```yaml
id: SPARK-BOM-G01
operation: "Bom.*"
type: field-resolver
...
complexity: Medium
depends_on: [SPARK-BOM-A02, SPARK-BOM-A05]
ext_services: [{key: workspaceV2, severity: YELLOW}, {key: tag, severity: BLUE}]
files: [plm-product/.../dataFetcher/BomEntityFieldDataFetcher.kt]
blocked_by: none
```
...
### SPARK-BOM-G02 · `BomMaterial_Unified` field resolvers (3 fields)
```yaml
id: SPARK-BOM-G02
operation: "BomMaterial_Unified.*"
type: field-resolver
category: CAT-2
phase: G
complexity: Medium
depends_on: [SPARK-BOM-A04, SPARK-BOM-A05]
ext_services: [{key: materialHub, severity: YELLOW}, {key: trim, severity: YELLOW}, {key: wash, severity: YELLOW}, {key: fabric, severity: RED}]
files: [plm-product/.../dataFetcher/BomMaterialUnifiedFieldDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-G03
operation: "BomMaterial.*"
type: field-resolver
category: CAT-2
phase: G
complexity: Medium
depends_on: [SPARK-BOM-A04, SPARK-BOM-A05]
ext_services: [{key: materialHub, severity: YELLOW}, {key: tag, severity: BLUE}]
files: [plm-product/.../dataFetcher/BomMaterialFieldDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-G04
operation: "BomPackagingMaterial.*"
type: field-resolver
category: CAT-2
phase: G
complexity: Low
depends_on: [SPARK-BOM-A04, SPARK-BOM-A05]
ext_services: [{key: tag, severity: BLUE}]
files: [plm-product/.../dataFetcher/BomPackagingMaterialFieldDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-G05
operation: "BomFabricMaterial.*"
type: field-resolver
category: CAT-2
phase: G
complexity: Low
depends_on: [SPARK-BOM-A04, SPARK-BOM-A05]
ext_services: [{key: search, severity: RED}, {key: tag, severity: BLUE}, {key: materialHub, severity: YELLOW}]
files: [plm-product/.../dataFetcher/BomFabricMaterialFieldDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-G06
operation: "BomFabricSpecMaterial.*"
type: field-resolver
category: CAT-2
phase: G
complexity: Low
depends_on: [SPARK-BOM-A04, SPARK-BOM-A05]
ext_services: [{key: fabric, severity: YELLOW}, {key: tag, severity: BLUE}, {key: materialHub, severity: YELLOW}]
files: [plm-product/.../dataFetcher/BomFabricSpecMaterialFieldDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-G07
operation: "BomCombinationMaterial.*"
type: field-resolver
category: CAT-2
phase: G
complexity: Low
depends_on: [SPARK-BOM-A04, SPARK-BOM-A05]
ext_services: [{key: combination, severity: YELLOW}, {key: tag, severity: BLUE}, {key: materialHub, severity: YELLOW}]
files: [plm-product/.../dataFetcher/BomCombinationMaterialFieldDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-G08
operation: "BomTrimMaterial.*"
type: field-resolver
category: CAT-2
phase: G
complexity: High
depends_on: [SPARK-BOM-A04, SPARK-BOM-A05]
ext_services: [{key: trim, severity: YELLOW}, {key: location, severity: BLUE}, {key: tag, severity: BLUE}]
files: [plm-product/.../dataFetcher/BomTrimMaterialFieldDataFetcher.kt, plm-product/.../service/TrimSizePresentation.kt, plm-product/.../service/TrimEnrichmentService.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-G09
operation: "BomWashMaterial.*"
type: field-resolver
category: CAT-2
phase: G
complexity: Low
depends_on: [SPARK-BOM-A04, SPARK-BOM-A05]
ext_services: [{key: wash, severity: YELLOW}, {key: tag, severity: BLUE}, {key: materialHub, severity: YELLOW}]
files: [plm-product/.../dataFetcher/BomWashMaterialFieldDataFetcher.kt]
blocked_by: none
```
...
### SPARK-BOM-G10 · `BomImpressionDetails_Unified` field resolvers (6 fields) — internal/external branch
```yaml
id: SPARK-BOM-G10
operation: "BomImpressionDetails_Unified.*"
type: field-resolver
category: CAT-2
phase: G
complexity: High
depends_on: [SPARK-BOM-A04, SPARK-BOM-A05]
ext_services: [{key: search, severity: RED}]
files: [plm-product/.../dataFetcher/BomImpressionDetailsFieldDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-G11
operation: "BomFabricLibraryImpressionDetails.libraryResource"
type: field-resolver
category: CAT-2
phase: G
complexity: Medium
depends_on: [SPARK-BOM-G10]
ext_services: [{key: search, severity: RED}]
files: [plm-product/.../dataFetcher/BomImpressionDetailsFieldDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-G12
operation: "BomTrimLibraryImpressionDetails.*"
type: field-resolver
category: CAT-2
phase: G
complexity: Medium
...
```yaml
id: SPARK-BOM-G13
operation: "BomTrimZipperLibraryImpressionDetails.*"
type: field-resolver
category: CAT-2
phase: G
complexity: Low
...
```yaml
id: SPARK-BOM-G14
operation: "trivial-passthroughs"
type: field-resolver
category: CAT-2
phase: G
complexity: Low
depends_on: [SPARK-BOM-A02]
ext_services: []
files: [plm-product/.../dataFetcher/BomTrivialFieldDataFetcher.kt]
blocked_by: none
```
...
```yaml
id: SPARK-BOM-G15
operation: "BomMaterialSearchResult.*"
type: field-resolver
category: CAT-2
phase: G
complexity: Medium
depends_on: [SPARK-BOM-A05, SPARK-BOM-C02]
ext_services: [{key: fabric, severity: YELLOW}, {key: search, severity: RED}]
files: [plm-product/.../dataFetcher/BomMaterialSearchResultFieldDataFetcher.kt]
blocked_by: none
```
...
phase: G
complexity: Medium
depends_on: [SPARK-BOM-B01, SPARK-BOM-E01, SPARK-BOM-G08, SPARK-BOM-G10]
ext_services: []
files: [plm-product/.../test/BomParityTest.kt, plm-product/.../test/BomDataFetcherTest.kt]
blocked_by: none
```
