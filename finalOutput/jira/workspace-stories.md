# workspace — Jira stories (paste one block per issue)

> **Epic:** Workspace → plm-workspace DGS migration  ·  **Labels:** `dgs-migration`, `workspace`, `<type>`
...
**Labels:** `dgs-migration`, `workspace`, `schema`
...
**Type:** Story  ·  **Phase:** A  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A01
**Labels:** `dgs-migration`, `workspace`, `schema`
...
**Type:** Story  ·  **Phase:** A  ·  **Complexity:** Low  ·  **Points (est.):** 2  ·  **Depends on:** SPARK-WS-A01
**Labels:** `dgs-migration`, `workspace`, `schema`
...
## SPARK-WS-A04 · WorkspaceServiceV2 port (plm-workspace)
**Type:** Story  ·  **Phase:** A  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A01
**Labels:** `dgs-migration`, `workspace`, `service`
...
## SPARK-WS-B01 · getWorkspaceV2
**Type:** Story  ·  **Phase:** B  ·  **Complexity:** Low  ·  **Points (est.):** 2  ·  **Depends on:** SPARK-WS-A02, SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `query`
...
## SPARK-WS-B02 · getWorkspacesByIdsV2
**Type:** Story  ·  **Phase:** B  ·  **Complexity:** Low  ·  **Points (est.):** 2  ·  **Depends on:** SPARK-WS-A02, SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `query`
...
**Type:** Story  ·  **Phase:** B  ·  **Complexity:** Low  ·  **Points (est.):** 2  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `query`
...
## SPARK-WS-B04 · findWorkspaceProductAndSampleIds
**Type:** Story  ·  **Phase:** B  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `query`
...
## SPARK-WS-B05 · findWorkspaceClaims
**Type:** Story  ·  **Phase:** B  ·  **Complexity:** Low  ·  **Points (est.):** 2  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `query`
...
## SPARK-WS-B06 · getWorkspacePackagingAttachments
**Type:** Story  ·  **Phase:** B  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `query`
...
**Type:** Story  ·  **Phase:** C  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `query`
...
## SPARK-WS-D01 · createWorkspaceV2 (dup-check throw)
**Type:** Story  ·  **Phase:** D  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `mutation`
...
## SPARK-WS-D02 · updateWorkspaceV2 (dup-check throw)
**Type:** Story  ·  **Phase:** D  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `mutation`
...
## SPARK-WS-D04 · addResourcesToWorkspaceV2 (product side-effect)
**Type:** Story  ·  **Phase:** D  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `mutation`
...
## SPARK-WS-D05 · removeWorkspaceResourcesV2 (product cleanup)
**Type:** Story  ·  **Phase:** D  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `mutation`
...
**Type:** Story  ·  **Phase:** D  ·  **Complexity:** Low  ·  **Points (est.):** 2  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `mutation`
...
**Type:** Story  ·  **Phase:** E  ·  **Complexity:** Very High  ·  **Points (est.):** 8  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `mutation`
...
## SPARK-WS-F01 · WorkspaceV2 entity fetcher (federated reference)
**Type:** Story  ·  **Phase:** F  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `field-resolver`
...
**Type:** Story  ·  **Phase:** F  ·  **Complexity:** Low  ·  **Points (est.):** 2  ·  **Depends on:** SPARK-WS-E01
**Labels:** `dgs-migration`, `workspace`, `schema`
...
**Type:** Story  ·  **Phase:** G  ·  **Complexity:** Very High  ·  **Points (est.):** 8  ·  **Depends on:** SPARK-WS-A02, SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `field-resolver`
...
**Type:** Story  ·  **Phase:** G  ·  **Complexity:** Very High  ·  **Points (est.):** 8  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `field-resolver`
...
**Type:** Story  ·  **Phase:** G  ·  **Complexity:** High  ·  **Points (est.):** 5  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `field-resolver`
...
## SPARK-WS-G05 · businessPartners + droppedPartners + notRemovable + unDroppable
**Type:** Story  ·  **Phase:** G  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `field-resolver`
...
## SPARK-WS-G06 · divisions/brands/clazzes/designCycles/tags + WorkspaceDepartmentV2
**Type:** Story  ·  **Phase:** G  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `field-resolver`
...
## SPARK-WS-G07 · createdBy/updatedBy/status/id + discussionsV2/teams + paged computed
**Type:** Story  ·  **Phase:** G  ·  **Complexity:** Medium  ·  **Points (est.):** 3  ·  **Depends on:** SPARK-WS-A04
**Labels:** `dgs-migration`, `workspace`, `field-resolver`
...
**Type:** Story  ·  **Phase:** G  ·  **Complexity:** High  ·  **Points (est.):** 5  ·  **Depends on:** SPARK-WS-B01, SPARK-WS-E01, SPARK-WS-G01, SPARK-WS-G02
**Labels:** `dgs-migration`, `workspace`, `tests`
