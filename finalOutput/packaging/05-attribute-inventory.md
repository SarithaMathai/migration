...
> Field types/nullability are taken from the source SDL (`code/schemas/SPARK_Packaging.txt`).
...
| `Packaging` | `status` / `statuses` | `CodeDescription` / `[ProductComponentStatus]` | Direct | — | Low | A02 |
