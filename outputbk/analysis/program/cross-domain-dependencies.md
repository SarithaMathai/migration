...
|---|---|---|---|
| `IMPRESSION-BE-F-01` — `Product.impressions` / `impressionCounts` (internal field resolver) | impression | product (`PRODUCT-BE-B-01`) | `PRODUCT-BE-B-01` |
...
---
*7 infrastructure gate(s) · 8 later-phase-subgraph gate(s).*