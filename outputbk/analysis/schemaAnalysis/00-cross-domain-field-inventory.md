...
> **Scope:** 8 phase-1 domains · **Generated:** 2026-07-19 · **Pipeline Version:** 1.0
...
| Metric | Value |
|---|---|
| Total resolvers scanned | 332 |
| Cross-domain/EXT dependent resolvers | 119 |
| Cross-domain fields with no client usage found | 98 |
...
| [Measurement](../measurement/be-06-cross-domain-field-analysis.md) | 29 | 10 | 0 | 0 | 0 | 10 | 8 |
...
| `SPARK_Measurements.measurementTemplates` | `measurementTemplate` (Measurement (templates) services) | Low |
| `SPARK_Measurements.product` | `product` (Product) | Low |
| `SPARK_Measurements.sizeTemplate` | `sizeTemplate` (Measurement (templates) services) | Low |
| `SPARK_Measurements.tightFitTemplate` | `tightFit` (Measurement (templates) services) | Low |
...
---
*Program roll-up · generated 2026-07-19 from each domain's `be-06-cross-domain-field-analysis.md`.*