...
> **Generated:** 2026-07-19 · **Scope:** 8 domains (phase 1) · `spark-internal-graphql` → Netflix DGS via Hive Schema Registry
...
| **Total backend stories** | **201** build stories (Phase-0 spikes tracked separately: 7 program spikes + their domain stubs) |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| [Product](./product/FederatedGqlBreakDown-product.md) | `plm-product (host)` | **69** | XXL | 5 | 4 | 27 | 33 | 194–326d | 12 | 66–102d | 🔴 High TechPack aggregation + partner drop/undrop orchestration |
...
| [Measurement](./measurement/FederatedGqlBreakDown-measurement.md) | `plm-product (co-located)` | **20** | M | 0 | 1 | 5 | 14 | 32–55d | 4 | 12–19d | 🟡 Medium `updateMeasurement` 2-step write + master-data cache |
...
| **TOTAL** | — | **201** | — | **6** | **13** | **74** | **108** | **432–733d** | **40** | **163–254d** | — |
...
| [Measurement](./measurement/FederatedGqlBreakDown-measurement.md) | 0 | 5 | 2 | 7 | 1 | 1 | 3 | 1 | **20** |
...
| **TOTAL** | **2** | **40** | **17** | **52** | **11** | **16** | **54** | **9** | **201** |
...
|---|---|---|---|
| `plm-product` | 1 | Product · BOM · Measurement · Packaging · Impression · Product Details · Watchlist | 181 |
...
---
*Program overview · generated 2026-07-19 from `output/analysis/*/04-*.md`.*