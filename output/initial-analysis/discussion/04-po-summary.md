...
|---|---|---|---|
| 1 | Consolidate v1/v2/V3 into one surface, or preserve all three? | B01 | Product Owner |
| 2 | `core*` twins — separate ops or one op with a context flag? | D11/D13/E02 | Backend Eng |
| 3 | Delete or `@deprecated`-keep the 3 drift ops (drop/undrop + `coreAddBulkDiscussionV3`); drop/undrop ownership with workspace | F03 | Product Owner |
