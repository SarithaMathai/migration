...
- Migration uses **facade-then-federate** (draft ADR-015 Option B; the catalogue label is "Option D (hybrid)") — see [federation-patterns-condensed.md §3](../../../fedMigrationScripts/reference/federation-patterns-condensed.md) and [ADR-015 (draft)](../../complexStories/techpack/01-adr-techpack.md).
