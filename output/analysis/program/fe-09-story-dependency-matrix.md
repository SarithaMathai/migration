...
| BOM-FE-002 | Migrate BOM core reads | High | BOM-BE-B-01, BOM-BE-B-03, BOM-FE-001 | BOM |
...
| MST-FE-001 | Migrate measurement reads and retire `humanId` | Medium | MST-BE-B-01, MST-BE-B-02 | Measurement |
| MST-FE-002 | Migrate measurement list/search reads | Medium | MST-BE-C-01, MST-BE-C-02 | Measurement |
| MST-FE-003 | Migrate measurement master-data reads | Low | MST-BE-B-02 | Measurement |
| MST-FE-004 | Migrate measurement mutations | Medium | MST-BE-D-02, MST-BE-D-06, MST-BE-D-07 | Measurement |
| PDTL-FE-001 | Migrate product-details reads | Low | PDTL-BE-B-01 | Product Details |
| PDTL-FE-002 | Migrate product-details simple mutations | Medium | PDTL-BE-D-01, PDTL-BE-D-02, PDTL-BE-D-04 | Product Details |
...
| PKG-FE-002 | Migrate packaging master-data reads and retire deprecated fields | Low | PKG-BE-B-02, PKG-BE-B-06 | Packaging |
| PKG-FE-003 | Migrate dieline flows | Medium | PKG-BE-B-02, PKG-BE-D-02 | Packaging |
| PKG-FE-004 | Migrate packaging simple mutations and export | Medium | PKG-BE-D-01, PKG-BE-D-03, PKG-BE-D-04, PKG-BE-D-02, PKG-BE-D-09 | Packaging |
...
| PRODUCT-FE-002 | Migrate shared-library `getProduct` consumers | Medium | PRODUCT-BE-B-01, PRODUCT-BE-B-02, PRODUCT-FE-001 | Product |
| PRODUCT-FE-003 | Migrate product list and bulk reads | High | PRODUCT-BE-S-02, PRODUCT-BE-B-02 | Product |
| PRODUCT-FE-004 | Migrate product status and workspace-context reads | Medium | PRODUCT-BE-B-02 | Product |
| PRODUCT-FE-005 | Migrate template library and categories reads | Medium | PRODUCT-BE-C-02, PRODUCT-BE-C-03 | Product |
| PRODUCT-FE-006 | Migrate product rules administration | Medium | PRODUCT-BE-B-06, PRODUCT-BE-B-10, PRODUCT-BE-C-05, PRODUCT-BE-D-14 | Product |
| PRODUCT-FE-007 | Migrate simple product mutations | Medium | PRODUCT-BE-D-01, PRODUCT-BE-D-02, PRODUCT-BE-D-03, PRODUCT-BE-D-04, PRODUCT-BE-D-05, PRODUCT-BE-D-10, PRODUCT-BE-D-14 | Product |
| PRODUCT-FE-008 | Migrate team and partner assignment mutations | Medium | PRODUCT-BE-D-06, PRODUCT-BE-D-10, PRODUCT-FE-001 | Product |
...
| BOM-BE-B-03 | BOM-FE-002, BOM-FE-004 |
| BOM-BE-B-05 | BOM-FE-004 |
| BOM-BE-B-08 | BOM-FE-004 |
| BOM-BE-C-01 | BOM-FE-003, BOM-FE-005 |
...
| PRODUCT-BE-B-02 | PRODUCT-FE-002, PRODUCT-FE-003, PRODUCT-FE-004 |
| PRODUCT-BE-B-06 | PRODUCT-FE-006 |
...
| PRODUCT-BE-D-06 | PRODUCT-FE-008, PRODUCT-FE-009 |
| PRODUCT-BE-D-10 | PRODUCT-FE-007, PRODUCT-FE-008 |
| PRODUCT-BE-D-14 | PRODUCT-FE-006, PRODUCT-FE-007 |
