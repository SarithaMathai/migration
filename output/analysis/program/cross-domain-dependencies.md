...
> **Generated:** 2026-07-24 · by `generate_cross_domain_deps.py` — collects every `**Blocked by:**` line already declared in each domain's `be-04-stories.md`; adds nothing new. Regenerate after any story's `Blocked by:` field changes.
