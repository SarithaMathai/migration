...
| Backend schema | Resolver | Frontend operation | Client constant | Components / hooks | FE story | BE story |
|---|---|---|---|---|---|---|
| `schemas/SPARK_TightFit.graphqls` | `addTightFit` | `addTightFit` | `ADD_TIGHT_FIT` | `TightFitTemplateNewLayout.tsx` | — | MST-BE-D-10 |
...
| `schemas/SPARK_TightFit.graphqls` | `getTightFits` | `getTightFits` | `GET_TIGHT_FITS` | — | — | MST-BE-B-08 |
...
| `schemas/SPARK_TightFit.graphqls` | `updateTightFit` | `updateTightFit` | `UPDATE_TIGHT_FIT` | `TightFitTemplateEditLayout.tsx` | — | — |
