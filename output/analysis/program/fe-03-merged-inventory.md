...
> Authoritative migration-planning inventory · Generated: 2026-07-19
...
|---|---|
| Phase-1 domains (8) — in scope | 156 |
| Later-phase / shared domains — out of scope | 574 |
...
### Measurement (`measurement`) — 16 rows · DGS: `plm-product (co-located)`

| Backend resolver (root field) | GraphQL kind | BE story | Client operation | Client constant | Client file | Components | Fields req. | Missing fields | Notes |
|---|---|---|---|---|---|---|---|---|---|
| `addTightFit` | mutation | MST-BE-D-10 | `addTightFit` | `ADD_TIGHT_FIT` | `src/libs/product-common/src/queries/TightFitQueries.tsx` | 1 | 2 | — | — |
...
| `getTightFits` | query | MST-BE-B-08 | `getTightFits` | `GET_TIGHT_FITS` | `src/libs/product-common/src/queries/TightFitQueries.tsx` | 0 | 2 | — | 2 fragment(s) |
...
| `updateTightFit` | mutation | — | `updateTightFit` | `UPDATE_TIGHT_FIT` | `src/libs/product-common/src/queries/TightFitQueries.tsx` | 1 | 1 | — | 2 fragment(s) |
...
| `getMaterialTypes` | query | `schemas/SPARK_SizeTemplate.graphqls` | Measurement |
| `getMeasurementTemplates` | query | `schemas/SPARK_MeasurementTemplate.graphqls` | Measurement |
| `getMeasurementTemplatesByIds` | query | `schemas/SPARK_MeasurementTemplate.graphqls` | Measurement |
...
| `getSizeCategories` | query | `schemas/SPARK_SizeTemplate.graphqls` | Measurement |
| `getSizeTemplates` | query | `schemas/SPARK_SizeTemplate.graphqls` | Measurement |
| `getTightFitByIdAndVersion` | query | `schemas/SPARK_TightFit.graphqls` | Measurement |
...
| `searchSparkSizes` | query | `schemas/SPARK_Sizes.graphqls` | Measurement |
| `addMeasurement` | mutation | `schemas/SPARK_Measurement.graphqls` | Measurement |
| `addMeasurementTemplate` | mutation | `schemas/SPARK_MeasurementTemplate.graphqls` | Measurement |
| `addSizeTemplate` | mutation | `schemas/SPARK_SizeTemplate.graphqls` | Measurement |
| `cloneFilesForDielines` | mutation | `schemas/SPARK_Packaging.graphqls` | Packaging |
| `deleteMeasurementTemplate` | mutation | `schemas/SPARK_MeasurementTemplate.graphqls` | Measurement |
...
| `updateMeasurementTemplate` | mutation | `schemas/SPARK_MeasurementTemplate.graphqls` | Measurement |
| `updateProductDetailAccess` | mutation | `schemas/SPARK_ProductDetail.graphqls` | Product Details |
| `updateSizeTemplate` | mutation | `schemas/SPARK_SizeTemplate.graphqls` | Measurement |
...
| `SPARK_CoreSizes` | *(entire type unreferenced by FE selections)* |
| `SPARK_Dieline` | `attachmentId`, `printerLocationId`, `sizeIds` |
| `SPARK_GradeInfo` | *(entire type unreferenced by FE selections)* |
...
| `SPARK_MeasurementTemplate` | *(entire type unreferenced by FE selections)* |
| `SPARK_MeasurementTemplateRow` | *(entire type unreferenced by FE selections)* |
| `SPARK_MeasurementTemplatesPaged` | *(entire type unreferenced by FE selections)* |
...
| `SPARK_RowTolerance` | *(entire type unreferenced by FE selections)* |
| `SPARK_ShippingDestination` | *(entire type unreferenced by FE selections)* |
| `SPARK_SizeGroup` | *(entire type unreferenced by FE selections)* |
| `SPARK_SizeTemplate` | *(entire type unreferenced by FE selections)* |
| `SPARK_SizeValues` | *(entire type unreferenced by FE selections)* |
| `SPARK_Sizes` | *(entire type unreferenced by FE selections)* |
...
| `SPARK_Unit_Of_Measure` | *(entire type unreferenced by FE selections)* |
