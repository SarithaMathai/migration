...
> [federation-patterns-condensed.md §0](../../../fedMigrationScripts/reference/federation-patterns-condensed.md).
...
## 6. ACL Handling
- Reads/writes curry a capability token via `getUserPermissionsJWT` (resource-scoped — the backend authorizes per construction set).
