...
```mermaid
graph TD
  B01["B-01"] --> G03["G-03"] & G04["G-04"] & G05["G-05"]
```
...
## 5. Summary
- **Stories:** 23 (B:6 · C:1 · D:9 · E:1 · F:1 · G:5). Bug-fix/test-coverage stories (`G-06`) tracked outside this Jira pipeline, created manually.
- **Critical path:** A-02/E-01→G-04.
