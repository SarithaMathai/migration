...
| REC-4 | `SampleMeasurementSet.sample: SampleV2` | forward ref pairs with the existing reverse extension (`SampleV2.sampleMeasurement`, MST-BE-H-01); zero extra backend calls (emit `{id: sampleId}`) | measurement → sample | Low | MST-BE-H-02 |
