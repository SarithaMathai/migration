...
**Must complete first:** BE — BOM-BE-A-04, BOM-BE-B-01, BOM-BE-B-03, BOM-BE-B-04, BOM-BE-G-01, BOM-BE-G-03, BOM-BE-G-08, BOM-BE-G-12, BOM-BE-G-13, BOM-BE-G-17, PRODUCT-BE-G-07, PRODUCT-BE-G-10, PRODUCT-BE-G-13 · Spikes — SPIKE-04 · New — NEW-BOM-BE-G-??
...
49 of 71 distinct fields/entities resolve to existing backend stories. 22 field(s) have no covering story yet (see the `NEW-...-??` placeholders above) and block full readiness until a real story is authored. 1 field(s) sit behind an unresolved spike (SPIKE-04) and cannot be built past the spike's decision.
