...
> Source: `schemas/*.graphqls` (spark-internal-graphql) · Generated: 2026-07-16
> Scope: the 8 phase-1 domain schemas. Cross-referenced against the frontend client inventory (01-client-inventory.md).

## Summary

| Stat | Count |
|---|---|
| Phase-1 schema files | 8 (of 74 total) |
| Object types (phase-1 files) | 114 |
| Input types (phase-1 files) | 90 |
| Interfaces (phase-1 files) | 2 |
| Enums (phase-1 files) | 0 |
| Unions (phase-1 files) | 0 |
| Custom scalars (gateway-wide) | 3 (Date, DateTime, JSON) |
| Phase-1 Query root fields | 60 |
| Phase-1 Mutation root fields | 63 |
| Phase-1 Query fields called by the frontend | 47 |
| Phase-1 Mutation fields called by the frontend | 50 |
...
- The remaining 66 schema files (later-phase and platform-stitched domains) are excluded per program scope.
