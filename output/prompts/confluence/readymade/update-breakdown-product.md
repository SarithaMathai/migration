...
- URL: https://confluence.target.com/spaces/PPDE/pages/1313880281/Federated+GraphQL+Breakdown+%E2%80%94+Product
- Page id: 1313880281  (space: PPDE)
- Keep the existing title as-is.

Source: finalArtifacts/summary/product/FederatedGqlBreakDown-product.md
...
- IDs that look like codes or tickets (e.g. PRODUCT-BE-B-01, SPIKE-04) stay as plain text —
...
Before writing, do a DRY RUN: confirm you resolved page id 1313880281 and its current title, and give a
...
Then ensure finalArtifacts/jira/confluence-page-map.csv has a row for product pointing at this page
(header "Domain,Breakdown Page URL,FE Readiness Page URL"; create the file if missing; update the
existing product row's Breakdown Page URL in place rather than adding a duplicate):
product,https://confluence.target.com/spaces/PPDE/pages/1313880281/Federated+GraphQL+Breakdown+%E2%80%94+Product,

---

Open page id 1313880281 and compare it section-by-section against
finalArtifacts/summary/product/FederatedGqlBreakDown-product.md. Confirm: same number of tables
