...
- URL: https://confluence.target.com/spaces/PPDE/pages/1313880252/Federated+GraphQL+Breakdown+%E2%80%94+Impression
- Page id: 1313880252  (space: PPDE)
- Keep the existing title as-is.

Source: finalArtifacts/summary/impression/FederatedGqlBreakDown-impression.md
...
- IDs that look like codes or tickets (e.g. IMPRESSION-BE-B-01, SPIKE-04) stay as plain text —
...
Before writing, do a DRY RUN: confirm you resolved page id 1313880252 and its current title, and give a
...
Then ensure finalArtifacts/jira/confluence-page-map.csv has a row for impression pointing at this page
(header "Domain,Breakdown Page URL,FE Readiness Page URL"; create the file if missing; update the
existing impression row's Breakdown Page URL in place rather than adding a duplicate):
impression,https://confluence.target.com/spaces/PPDE/pages/1313880252/Federated+GraphQL+Breakdown+%E2%80%94+Impression,

---

Open page id 1313880252 and compare it section-by-section against
finalArtifacts/summary/impression/FederatedGqlBreakDown-impression.md. Confirm: same number of tables
