...
- URL: https://confluence.target.com/spaces/PPDE/pages/1313880249/Federated+GraphQL+Breakdown+%E2%80%94+Claims
- Page id: 1313880249  (space: PPDE)
- Keep the existing title as-is.

Source: finalArtifacts/summary/claims/FederatedGqlBreakDown-claims.md
...
- IDs that look like codes or tickets (e.g. CLAIM-BE-B-01, SPIKE-04) stay as plain text —
...
Before writing, do a DRY RUN: confirm you resolved page id 1313880249 and its current title, and give a
...
Then ensure finalArtifacts/jira/confluence-page-map.csv has a row for claims pointing at this page
(header "Domain,Breakdown Page URL,FE Readiness Page URL"; create the file if missing; update the
existing claims row's Breakdown Page URL in place rather than adding a duplicate):
claims,https://confluence.target.com/spaces/PPDE/pages/1313880249/Federated+GraphQL+Breakdown+%E2%80%94+Claims,

---

Open page id 1313880249 and compare it section-by-section against
finalArtifacts/summary/claims/FederatedGqlBreakDown-claims.md. Confirm: same number of tables
