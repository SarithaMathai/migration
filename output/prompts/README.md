...
| Prompt | Use when |
|---|---|
| [publish-domain-breakdown.md](confluence/publish-domain-breakdown.md) | Publish or re-sync one domain's merged BE+FE breakdown page, zero data/format loss — repeat once per domain |
| [publish-domain-breakdown-claude-sonnet.md](confluence/publish-domain-breakdown-claude-sonnet.md) | Same as above, standalone version for exporting to a repo with no Claude Code — Copilot + org Claude, Sonnet (transcription task, not judgment-call) |
