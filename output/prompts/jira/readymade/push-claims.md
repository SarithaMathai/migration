...
finalArtifacts/jira/claims.csv. Attach every story to this epic: <EPIC_LINK>.

This CSV holds the Claims domain: backend stories (Story IDs like CLAIM-BE-B-01) and frontend
stories (Story IDs like CLAIM-FE-001). Ignore the two Issue Type=Epic rows in the CSV — use the
...
- REWRITE the "Full story:" line from a relative path into a real URL:
  "Full story: https://github.com/target-corp/saritha-mathai-repositories-research/blob/main/output/analysis/claims/be-04-stories.md#<Story ID>"
- ADD a "Domain overview:" link if finalArtifacts/jira/confluence-page-map.csv has a row for claims;
